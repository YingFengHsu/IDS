...
fp=open('/data/lee/newdataset/FullTest-DoS-TrainVali-coif3-3.txt')
X=json.load(fp)
...
rfe = RFE(estimator=clf, n_features_to_select=1, step=4)

rfe.fit(X, y)

print(str(rfe.ranking_), file=codecs.open('RFE-Ranking-coif3-3.txt', 'a', 'utf-8'))
